...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SplashController loading = new LoadingSplashView(this, Color.parseColor("#000000"), "FILE MANAGER", 5);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            // embedded WebView (they detect the "; wv)" user-agent token
            // and just leave the "Next" button inert) -- this is enforced
            ...
            // https://myapp.com/ App Link registered in the manifest
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                if (request.isForMainFrame() && "accounts.google.com".equals(uri.getHost())) {
                    try {
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "FILE MANAGER" : title;
    ...
    // its own "FILE MANAGER" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "FILE MANAGER/" + filename);
