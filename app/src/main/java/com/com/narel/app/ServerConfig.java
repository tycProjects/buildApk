...
public final class ServerConfig {
    ...
    public static String getBaseUrl() {
        return decode(new int[] { 197, 184, 159, 122, 90, 114, 72, 169, 215, 161, 141, 122, 64, 41, 44, 11, 244, 200, 190, 215, 114, 76, 38, 69, 255, 208, 162, 128, 63, 93, 46, 0, 248, 223, 229, 153, 121, 73, 36, 3, 170 }, 173);
    }
