...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SplashController loading = new LoadingSplashView(this, Color.parseColor("#000000"), "mdmdkdk", 0);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            // OfflineCache. Online, it fetches fresh and updates the cache;
            // offline (or the fetch itself fails), it serves back whatever
            // was cached from the last time this exact URL loaded
            // successfully. First-ever launch with no connection and nothing
    ...
    private String baseUrl() {
        return "https://zip-to-apk-ce53.onrender.com/";
    }
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "mdmdkdk" : title;
    ...
    // its own "mdmdkdk" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "mdmdkdk/" + filename);
