...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SplashController loading = new CustomSplashView(this, Color.parseColor(UrlObfuscator.decode(new int[] { 202, 56, 23, 118, 85, 180, 147 }, 233)), true);
        ...
        // <meta name=UrlObfuscator.decode(new int[] { 63, 2, 236, 197, 162, 203, 102, 75, 47, 13, 243 }, 75)>, if it has one, and recolors the
        ...
        webView.addJavascriptInterface(new AndroidBridge(), UrlObfuscator.decode(new int[] { 29, 21, 254, 203, 183, 158, 114, 119, 38, 26, 246, 214, 181 }, 92));
        ...
        // waiting for a tap. Falls back to manual UrlObfuscator.decode(new int[] { 57, 237, 219, 234, 157, 103, 7, 52, 0, 240, 209, 187 }, 109) if this
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // Picks up the page's <meta name=UrlObfuscator.decode(new int[] { 10, 245, 217, 182, 159, 52, 91, 56, 26, 250, 198 }, 126)> (if it has
                ...
                view.evaluateJavascript(
                    UrlObfuscator.decode(new int[] { 167, 200, 184, 130, 104, 94, 32, 7, 233, 142, 236, 159 }, 143) +
                    ...
                    // wrapped site read as UrlObfuscator.decode(new int[] { 193, 159, 169, 152, 126, 72, 51, 13, 253, 155, 246, 155, 123, 71, 114, 16, 176, 193, 175, 153, 101, 93, 47, 73, 233, 215, 182 }, 160).
                    ...
                    UrlObfuscator.decode(new int[] { 197, 162, 150, 117 }, 177) +
                    "var vp=document.querySelector('meta[name=\"viewport\"]');" +
                    UrlObfuscator.decode(new int[] { 171, 135, 40, 62, 72, 45, 85, 224, 204, 169, 197, 115, 89, 54, 1, 254, 215, 191, 132, 33, 77, 63, 9, 234, 222, 172, 173, 107, 67, 40, 1, 237, 214, 233, 199, 146, 123, 73, 61, 92, 179, 130, 174, 135, 56, 70, 49, 7, 211, 197, 164, 157, 103, 79, 57, 31, 239, 129, 239, 137, 103, 72, 33, 68, 174, 134, 182, 182, 155, 106, 76, 52, 8, 237, 159, 254, 205, 113, 91, 48, 7, 252, 213, 161, 154, 35, 68, 46, 11, 237, 134, 166, 150, 117, 65, 45, 6, 194, 200, 214, 178, 153, 52, 77, 42, 80, 163, 202 }, 194) +
                    UrlObfuscator.decode(new int[] { 165, 130, 63, 67, 42, 26, 204, 216, 191, 152, 96, 74, 50, 18, 224, 140, 228, 129, 110, 78, 75, 59, 19, 232, 156, 246, 222, 111, 94, 50, 1, 252, 142, 182, 148, 102, 70, 45, 8, 161, 220, 163, 141, 124, 79, 106, 69, 237, 205, 171, 149, 105, 126, 82, 112, 15, 248, 219, 181, 157, 42, 7, 123, 68, 191, 146, 188, 145, 119, 71, 32, 25, 230, 135, 186, 139, 102, 74, 32, 89, 178, 140, 241, 204, 223, 107, 78, 57, 9, 183, 202, 187, 150, 122, 84, 54, 31, 247, 140, 190, 128, 41, 4, 119 }, 211) +
                    UrlObfuscator.decode(new int[] { 141, 101, 10, 96, 4, 16, 253, 200, 177, 158, 116, 77, 118, 16, 243, 193, 145, 159, 119, 92, 53, 1, 250, 239, 181, 162, 110, 1, 111, 56, 217, 196, 170, 135, 112, 78, 41, 59, 40, 244, 217, 172, 138, 118, 74, 35, 48, 252, 204, 244, 219, 56, 75 }, 228) +
                    UrlObfuscator.decode(new int[] { 220, 181, 159, 126, 77, 37, 74, 160, 215, 214, 176, 153, 115, 76, 116, 38, 199, 214, 184, 145, 102, 92, 59, 21, 216, 206, 190, 153, 101, 72, 57, 43, 231, 210, 168, 129, 45, 88, 53, 8, 238, 251, 209, 170, 210, 68, 101, 56, 22, 243, 196, 186, 157, 119, 122, 48, 0, 251, 199, 174, 159, 73, 69, 60, 6, 227, 155, 177, 150, 118, 71, 122 }, 168) +
                    UrlObfuscator.decode(new int[] { 221, 183, 148, 99, 88, 49, 29, 230, 159, 177, 139, 106, 104, 58, 14, 228, 221, 132, 142, 117, 81, 33, 13, 231, 211, 232, 248, 157, 113, 85, 56, 17, 190, 148, 177, 131, 123, 87, 39, 27, 254, 222, 231, 139, 36, 87 }, 185) +
                    "var t=e.target;var el=t&&t.closest?t.closest('button,a,[role=\"button\"],input[type=\"button\"],input[type=\"submit\"]'):null;" +
                    UrlObfuscator.decode(new int[] { 163, 143, 32, 66, 42, 67, 162, 212, 171, 143, 100, 112, 73, 115, 61, 245, 222, 171, 151, 126, 82, 23, 6, 250, 214, 182, 149, 41, 8, 12, 2, 239, 216, 166, 129, 99, 100, 55, 13, 231, 197, 164, 206, 137, 119, 95, 46, 26, 238, 220, 241, 140, 87, 91, 48, 1, 253, 216, 180, 173, 124, 68, 40, 12, 239, 135, 190, 142, 100, 87, 37, 23, 231, 137, 233, 228, 131 }, 202) +
                    UrlObfuscator.decode(new int[] { 166, 214, 109, 74, 34, 19, 188, 143, 174, 143, 114, 81, 59, 13, 229, 132, 174, 195, 114, 85 }, 219) +
                    // Polyfills the Web Share API on top of the real Android
                    // share sheet -- most WebView builds don't implement
                    // navigator.share at all, so a page's own UrlObfuscator.decode(new int[] { 191, 99, 75, 59, 13 }, 236) button
                    ...
                    UrlObfuscator.decode(new int[] { 137, 110, 66, 33, 16, 254, 159, 161, 156, 122, 87, 61, 6, 190, 238, 160, 137, 126, 68, 35, 13, 202, 213, 175, 129, 99, 70, 100, 71, 193, 241, 218, 175, 147, 114, 94, 27, 10, 254, 210, 178, 145, 61, 65, 57, 17, 253, 203, 235, 202, 42, 68, 40, 30, 238, 193, 164, 144, 108, 80, 111, 19, 23, 255, 207, 185, 210, 97 }, 253) +
                    UrlObfuscator.decode(new int[] { 96, 76, 58, 2, 237, 200, 188, 136, 116, 11, 55, 11, 227, 211, 165, 226, 152, 104, 82, 56, 14, 240, 215, 185, 222, 113, 85, 39, 19, 184, 203 }, 270) +
                    UrlObfuscator.decode(new int[] { 123, 95, 41, 29, 166, 222, 184, 140, 118, 74, 41, 15, 238, 137 }, 287) +
                    UrlObfuscator.decode(new int[] { 65, 38, 10, 233, 240, 190, 139, 124, 66, 37, 15, 200, 219, 161, 131, 97, 64, 106, 16, 234, 192, 178, 186, 214, 78, 72, 41, 19, 247, 223, 255, 146, 116, 64, 50, 92, 229, 217, 187, 130, 104, 80, 55, 77, 174, 129, 235, 181, 113, 86, 42, 12, 230, 136, 219, 191, 137, 125, 21, 46, 28, 224, 195, 170, 137, 51, 20, 123, 93, 195, 219, 188, 132, 98, 76, 98, 13, 233, 211, 167, 203, 113, 81, 46, 29, 252, 184, 153, 244, 213, 32 }, 53) +
                    UrlObfuscator.decode(new int[] { 153, 105, 6, 58, 5, 229, 206, 166, 159, 41, 103, 43, 0, 241, 205, 168, 132, 189, 108, 84, 56, 28, 255, 159, 254, 182, 120, 81, 38, 28, 251, 213, 146, 157, 103, 73, 43, 14, 164, 219, 173, 151, 105, 87, 48, 48, 225, 211, 175, 179, 146, 73, 83, 43, 83, 226, 249, 185, 146, 103, 91, 58, 22, 211, 194, 166, 138, 106, 73, 101, 24, 236, 216, 168, 148, 113, 119, 32, 16, 238, 204, 211, 138, 146, 108, 19, 46, 22, 232, 203, 230, 220, 47, 78 }, 240) +
                    UrlObfuscator.decode(new int[] { 124, 9, 4, 35, 81, 232, 201, 175, 156, 49, 12, 43, 8, 247, 210, 166, 146, 120, 7, 43, 68, 247, 214 }, 257) +
                    UrlObfuscator.decode(new int[] { 111, 24, 120, 70, 181 }, 274),
                    null);
            }
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                if (rel.isEmpty()) rel = UrlObfuscator.decode(new int[] { 74, 44, 5, 229, 231, 144, 181, 136, 118, 86 }, 291);

                byte[] data = EmbeddedAssets.get(rel);
                if (data == null) return super.shouldInterceptRequest(view, request);

                return new WebResourceResponse(guessEmbeddedMime(rel), UrlObfuscator.decode(new int[] { 108, 12, 49, 187, 141 }, 57), new ByteArrayInputStream(data));
            }

            private String guessEmbeddedMime(String rel) {
                String lower = rel.toLowerCase();
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 100, 1, 252, 202, 170 }, 74)) || lower.endsWith(UrlObfuscator.decode(new int[] { 117, 18, 237, 213 }, 91))) return UrlObfuscator.decode(new int[] { 24, 238, 210, 189, 199, 111, 82, 40, 8 }, 108);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 83, 255, 200, 169 }, 125))) return UrlObfuscator.decode(new int[] { 250, 200, 180, 159, 37, 74, 59, 20 }, 142);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 177, 212, 174 }, 159)) || lower.endsWith(UrlObfuscator.decode(new int[] { 158, 162, 132, 126 }, 176))) return UrlObfuscator.decode(new int[] { 160, 144, 143, 114, 84, 63, 26, 238, 208, 183, 153, 57, 95, 53, 5, 243, 194, 179, 157, 103, 93, 56 }, 193);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 252, 155, 99, 64, 32 }, 210))) return UrlObfuscator.decode(new int[] { 130, 114, 81, 44, 54, 29, 252, 200, 178, 149, 119, 23, 61, 5, 250, 218 }, 227);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 218, 96, 68, 54 }, 244))) return UrlObfuscator.decode(new int[] { 108, 73, 34, 5, 228, 143, 204, 168, 154, 55, 67, 55, 21 }, 261);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 56, 69, 58, 20 }, 278))) return UrlObfuscator.decode(new int[] { 78, 43, 4, 227, 198, 237, 145, 110, 120 }, 295);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 19, 54, 11, 253 }, 61)) || lower.endsWith(UrlObfuscator.decode(new int[] { 96, 7, 252, 206, 173 }, 78))) return UrlObfuscator.decode(new int[] { 54, 19, 252, 219, 190, 213, 115, 72, 50, 17 }, 95);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 94, 232, 199, 171 }, 112))) return UrlObfuscator.decode(new int[] { 232, 205, 222, 185, 152, 51, 92, 51, 31 }, 129);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 188, 198, 181, 141, 126 }, 146))) return UrlObfuscator.decode(new int[] { 202, 175, 128, 103, 122, 17, 42, 25, 249, 202 }, 163);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 154, 164, 157, 119, 86, 125 }, 180))) return UrlObfuscator.decode(new int[] { 163, 139, 109, 86, 110, 23, 16, 248, 219, 238 }, 197);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 248, 130, 123, 85, 52 }, 214))) return UrlObfuscator.decode(new int[] { 129, 105, 75, 48, 76, 245, 206, 166, 185 }, 231);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 214, 99, 66, 51 }, 248))) return UrlObfuscator.decode(new int[] { 111, 71, 41, 18, 170, 208, 183, 132 }, 265);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 52, 80, 59, 24 }, 282))) return UrlObfuscator.decode(new int[] { 89, 34, 15, 234, 201, 228, 146, 36, 65, 36, 9, 235 }, 48);
                return UrlObfuscator.decode(new int[] { 32, 16, 15, 242, 212, 191, 154, 110, 80, 55, 25, 185, 218, 183, 135, 119, 69, 125, 28, 250, 223, 169, 138, 103 }, 65);
            }
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            // UrlObfuscator.decode(new int[] { 1, 18, 241, 193, 238, 188, 94 }, 82) feature or a video-chat widget using getUserMedia().
            // Without this override the WebView auto-denies every such
            // request, which is what was showing as UrlObfuscator.decode(new int[] { 32, 227, 204, 165, 173, 159, 61, 76, 62, 8, 244, 209, 164, 133, 124, 91, 61, 120, 177, 144, 239, 206, 45, 12, 107, 74, 169, 136, 231, 198, 42, 11, 99, 6, 228, 206, 214, 187, 153, 60, 84, 40, 89, 237, 217, 183, 131, 117, 90, 62, 16, 242, 195, 171 }, 99) -- the app never even asked Android for
            ...
            // watchPosition() calls (e.g. a UrlObfuscator.decode(new int[] { 18, 250, 220, 181, 208, 124, 90, 34, 30, 238, 217, 233, 134, 98, 71, 55, 68, 238, 199 }, 116) feature).
            ...
            // UrlObfuscator.decode(new int[] { 246, 205, 164, 140, 33, 73, 81, 126, 10, 245, 207, 178, 217, 104, 88, 38, 0, 228 }, 133) flows work. A bare WebView has nowhere to put
            // that second window, so without this override the popup silently
            // fails (or opens detached from the parent page) and the auth
            // handler comes back with UrlObfuscator.decode(new int[] { 194, 221, 177, 211, 96, 84, 33, 26, 235, 222, 184, 142, 110, 9, 41, 4, 242, 204, 171, 141, 34, 72, 51, 127, 23, 243, 202, 186, 150, 112, 92 }, 150).
            //
            ...
            public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
                ...
                // needs the same UrlObfuscator.decode(new int[] { 156, 230, 146, 114, 10 }, 167)/UrlObfuscator.decode(new int[] { 238, 178, 132, 102, 93, 60, 28, 190, 232, 225, 182, 45 }, 184) stripping or it hits
                // the same silent block.
                String popupDefaultUA = popupSettings.getUserAgentString();
                popupSettings.setUserAgentString(popupDefaultUA.replace(UrlObfuscator.decode(new int[] { 242, 200, 112, 80 }, 201), "").replaceAll("Version/[0-9.]+\s", ""));
                ...
                popupWebView.setWebViewClient(new WebViewClient() {
                    // window.open() targets (like the UrlObfuscator.decode(new int[] { 143, 137, 124, 86, 34, 16, 180, 221, 189, 134 }, 218) link) can land
                    ...
                    // and shows Android's raw UrlObfuscator.decode(new int[] { 188, 111, 75, 56, 6, 225, 192, 228, 141, 109, 85, 96, 62, 8, 252, 213, 183, 155, 123, 84, 50, 86, 186, 190, 243, 210, 49, 16, 111, 78, 173, 140, 235, 202, 41, 8, 103, 70, 165, 132, 227, 194, 33, 0, 16, 113, 93, 217, 233, 136, 166, 77, 121, 29, 59, 219, 228, 156, 174, 69, 125, 2, 50, 223, 232, 130, 172, 69, 98 }, 235) error. Intercept here and hand the URL
                    ...
                    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                        ...
                        if (scheme != null && !scheme.equals(UrlObfuscator.decode(new int[] { 148, 111, 78, 41 }, 252)) && !scheme.equals(UrlObfuscator.decode(new int[] { 101, 88, 63, 26, 250 }, 269))) {
                            try {
    ...
    private String baseUrl() {
        return EMBED_HOST + UrlObfuscator.decode(new int[] { 119, 83, 56, 30, 226, 151, 176, 131, 123, 89 }, 286);
    }
    ...
    private String resolveStartUrl(Intent intent) {
        ...
        if (Intent.ACTION_SEND.equals(action) && UrlObfuscator.decode(new int[] { 64, 54, 10, 229, 159, 191, 130, 108, 69, 37 }, 52).equals(intent.getType())) {
            String shared = intent.getStringExtra(Intent.EXTRA_TEXT);
            if (shared != null && !shared.isEmpty()) {
                try {
                    return baseUrl() + UrlObfuscator.decode(new int[] { 122, 23, 235, 195, 179, 133, 155, 65, 73, 57, 3, 238, 132 }, 69) + java.net.URLEncoder.encode(shared, UrlObfuscator.decode(new int[] { 3, 33, 210, 158, 234 }, 86));
    ...
    protected void onNewIntent(Intent intent) {
        ...
        String shortcutAction = intent.getStringExtra(UrlObfuscator.decode(new int[] { 20, 238, 202, 182, 151, 97, 84, 52, 0, 31, 254, 200, 178, 149, 119 }, 103));
        if (UrlObfuscator.decode(new int[] { 10, 242, 218, 186, 149, 119 }, 120).equals(shortcutAction)) {
            webView.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);
            webView.reload();
            webView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            return;
        }
        if (UrlObfuscator.decode(new int[] { 225, 199, 170, 131 }, 137).equals(shortcutAction)) {
    ...
    // system bars to match the page's own <meta name=UrlObfuscator.decode(new int[] { 238, 209, 189, 154, 115, 24, 55, 28, 254, 222, 162 }, 154)>
    ...
    private class AndroidBridge {
        ...
        public void share(String title, String text, String url) {
            runOnUiThread(() -> {
                try {
                    ...
                    sendIntent.setType(UrlObfuscator.decode(new int[] { 223, 175, 145, 124, 8, 54, 9, 229, 202, 172 }, 171));
        ...
        // the app is open or backgrounded (e.g. on a socket.io UrlObfuscator.decode(new int[] { 210, 190, 141, 57, 85, 50, 5, 230, 213, 180, 151 }, 188)
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? UrlObfuscator.decode(new int[] { 174, 131, 102, 4, 49, 7, 233, 195, 177, 158, 122, 86, 53, 78, 23, 250 }, 205) : title;
    ...
    //    UrlObfuscator.decode(new int[] { 102, 46, 23, 17, 242, 210, 189, 159, 58, 90, 55, 26, 230, 217, 177, 135, 119 }, 290)) instead of the app being the only place any
    //    progress is visible;
    ...
    // its own UrlObfuscator.decode(new int[] { 91, 56, 27, 187, 204, 188, 156, 116, 68, 53, 23, 249, 216, 229, 130, 109 }, 56) subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.addRequestHeader(UrlObfuscator.decode(new int[] { 28, 27, 226, 212, 232, 165, 100, 71, 47, 20 }, 73), userAgent);
            if (cookie != null) request.addRequestHeader(UrlObfuscator.decode(new int[] { 25, 22, 247, 220, 191, 144 }, 90), cookie);
            request.setTitle(filename);
            request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, UrlObfuscator.decode(new int[] { 8, 229, 196, 230, 159, 105, 75, 33, 23, 248, 216, 180, 171, 208, 117, 88, 116 }, 107) + filename);
            ...
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 56, 244, 205, 183, 148, 120, 87, 49, 29, 253, 213, 241 }, 124) + filename + "…", Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 201, 195, 188, 132, 101, 71, 38, 2, 165, 194, 162, 139, 109, 69, 91, 126, 80, 177, 155, 185, 145, 125, 84, 61, 85, 237, 220, 167, 131, 48, 76, 33, 3, 226, 206, 169, 157, 97, 72, 40, 69, 229, 205, 166, 193, 116, 109, 71, 125, 29, 252, 219, 176, 150 }, 141), Toast.LENGTH_LONG).show();
        }
    }

    // Confirms the download actually finished (or explains why it didn't)
    // instead of leaving the UrlObfuscator.decode(new int[] { 218, 210, 171, 149, 118, 86, 57, 19, 255, 219, 179, 221, 60, 31 }, 158) toast above as the last word
    ...
    private void handleDownloadComplete(long id) {
        ...
        try {
            ...
            String title = (titleIdx >= 0 && cursor.getString(titleIdx) != null) ? cursor.getString(titleIdx) : UrlObfuscator.decode(new int[] { 233, 167, 129, 105 }, 175);

            if (status == DownloadManager.STATUS_SUCCESSFUL) {
                String localUriStr = uriIdx >= 0 ? cursor.getString(uriIdx) : null;
                String folderName = UrlObfuscator.decode(new int[] { 132, 176, 137, 115, 80, 52, 27, 253, 203 }, 192);
                ...
                if (localUriStr != null) {
                    ...
                    if (path != null) {
                        ...
                        // the saved path (rather than hardcoding UrlObfuscator.decode(new int[] { 149, 159, 120, 64, 33, 3, 234, 206, 186 }, 209))
                ...
                Toast.makeText(this, title + UrlObfuscator.decode(new int[] { 194, 101, 79, 72, 48, 17, 243, 218, 190, 156, 124, 23, 8258, 85, 242, 218, 188, 149, 48, 70, 58, 77, 229, 197, 234, 144, 103, 82, 52, 69 }, 226) + folderName + UrlObfuscator.decode(new int[] { 211, 116, 94, 60, 11, 235, 223 }, 243), Toast.LENGTH_LONG).show();
                ...
                // links to) still behaves exactly as before, since UrlObfuscator.decode(new int[] { 109, 77, 49, 21, 225, 243, 210 }, 260)
                // wouldn't mean anything for those.
                if (localPath != null && title != null && title.toLowerCase().endsWith(UrlObfuscator.decode(new int[] { 59, 85, 35, 25 }, 277))) {
                    File apkFile = new File(localPath);
                    if (apkFile.exists()) {
                        try {
                            Uri contentUri = FileProvider.getUriForFile(
                                this, getPackageName() + UrlObfuscator.decode(new int[] { 8, 35, 13, 239, 199, 177, 146, 144, 104, 84, 56, 30, 232 }, 294), apkFile);
                ...
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 120, 52, 13, 247, 212, 184, 151, 113, 20, 53, 19, 248, 220, 170, 138, 55, 12 }, 60) + title + UrlObfuscator.decode(new int[] { 109, 68, 238, 216, 187, 135, 117, 6 }, 77) + reason + ")", Toast.LENGTH_LONG).show();
    ...
    // in the wrapped page's script. Without this, the button's UrlObfuscator.decode(new int[] { 58, 18, 242, 222 }, 94) state
    // was just a fixed timer guessing how long a download UrlObfuscator.decode(new int[] { 31, 252, 194, 174, 138, 104, 69, 49 }, 111) takes,
    // with no way to know the real file size or connection speed -- so a
    // large APK on a slow connection could show UrlObfuscator.decode(new int[] { 243, 247, 209, 168, 144, 127, 26, 59, 29, 183, 223, 187, 212, 106, 93, 36, 2, 133, 142, 237, 204, 43, 5, 102, 72, 227, 201, 178, 138, 111, 77, 32, 4, 12 }, 128) while DownloadManager was still genuinely working. Fire-
        ...
        runOnUiThread(() -> {
            try {
                webView.evaluateJavascript(
                    UrlObfuscator.decode(new int[] { 229, 194, 182, 149, 100, 74, 99, 29, 224, 198, 163, 137, 114, 10, 28, 61, 238, 206, 241, 191, 137, 117, 77, 63, 61, 247, 192, 184, 153, 123, 82, 54, 50, 255, 194, 190, 129, 105, 95, 47, 64, 243, 208, 175, 139, 96, 76, 53, 79, 223, 192, 209, 179, 178, 122, 78, 48, 14, 242, 242, 186, 131, 125, 94, 62, 17, 235, 237, 162, 129, 123, 70, 44, 28, 226, 142 }, 145) + success + UrlObfuscator.decode(new int[] { 139, 250, 157, 130, 125, 92, 40, 24, 242, 145, 189, 222, 109, 72 }, 162),
                    null);
            } catch (Exception ignored) {
    ...
    // it (rather than a generic UrlObfuscator.decode(new int[] { 212, 189, 209, 100, 64, 110, 62, 233, 223, 190, 128, 102, 64, 53 }, 179) toast) and parks the
    ...
    private void requestInstall(Uri contentUri) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && !getPackageManager().canRequestPackageInstalls()) {
            ...
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 133, 143, 110, 78, 55, 127, 23, 243, 207, 175, 155, 117, 84, 36, 86, 243, 198, 188, 159, 49, 68, 39, 7, 254, 140, 170, 154, 121, 4, 103, 18, 237, 193, 173, 194, 104, 84, 24, 50, 17, 188, 216, 181, 151, 108, 94, 56, 0, 241, 147, 179, 132, 100, 64, 35, 12, 248, 194, 169, 136, 100, 75, 63 }, 196), Toast.LENGTH_LONG).show();
            try {
    ...
    private void launchInstall(Uri contentUri) {
        ...
        installIntent.setDataAndType(contentUri, UrlObfuscator.decode(new int[] { 135, 117, 84, 47, 11, 226, 193, 203, 183, 146, 114, 20, 44, 23, 252, 153, 183, 155, 112, 65, 61, 24, 244, 129, 190, 140, 111, 64, 43, 14, 237, 138, 167, 151, 103, 75, 43, 23, 229 }, 230));
        installIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_GRANT_READ_URI_PERMISSION);
        try {
            startActivity(installIntent);
        } catch (ActivityNotFoundException e) {
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 185, 121, 21, 61, 29, 225, 197, 177, 131, 98, 72, 62, 75, 236, 198, 189, 137, 98, 5, 105, 78, 162, 206, 176, 186, 144, 61, 72, 51, 31, 185, 222, 190, 154, 112, 20, 53, 0, 254, 221, 239, 151, 98, 89, 57, 74, 205, 199, 176, 136, 105, 75, 34, 6, 242, 128, 217, 177, 145, 120, 94, 40, 89, 241, 217, 165, 129, 113, 82, 54 }, 247), Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == STORAGE_PERMISSION_REQUEST_CODE && pendingDownload != null) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 91, 83, 41, 23, 229, 196, 167, 193, 112, 122, 76, 48, 21, 232, 201, 176, 151, 121, 22, 60, 7, 179, 220, 180, 149, 107, 75, 41, 76, 255, 197, 233, 155, 102, 80, 32, 68, 247, 202, 164, 192, 155, 113, 74, 50, 23, 245, 216, 188 }, 264), Toast.LENGTH_LONG).show();
            }
            ...
            if (grantedResources.isEmpty()) {
                request.deny();
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 90, 89, 58, 19, 231, 213, 252, 159, 120, 83, 61, 1, 253, 196, 164, 132, 108, 8, 55, 3, 247, 201, 170, 145, 114, 73, 80, 48, 93, 245, 200, 250, 151, 125, 82, 50, 16, 240, 147, 180, 158, 98, 15, 58, 5, 229, 216 }, 281), Toast.LENGTH_LONG).show();
            } else {
            ...
            if (!granted) {
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 99, 33, 14, 237, 223, 163, 134, 102, 7, 54, 0, 246, 206, 171, 146, 115, 118, 81, 51, 92, 242, 201, 249, 150, 114, 83, 49, 17, 247, 146, 183, 159, 125, 14, 57, 4, 226, 217 }, 47), Toast.LENGTH_LONG).show();
            }
        } else if (requestCode == NOTIFICATION_PERMISSION_REQUEST_CODE) {
            if (!(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 14, 48, 10, 244, 218, 178, 153, 120, 76, 62, 25, 251, 199, 243, 147, 99, 85, 111, 1, 235, 202, 235, 140, 102, 90, 103, 18, 237, 205, 176, 194, 96, 80, 79, 126, 80, 177, 155, 174, 140, 106, 89, 118, 1, 252, 214, 191, 209, 127, 65, 110, 4, 226, 139, 153, 140, 124, 83, 47, 11, 227, 208, 226, 128, 110, 102, 30, 41, 21, 246, 223 }, 64), Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void createNotificationChannel() {
        ...
        NotificationChannel channel = new NotificationChannel(
            UrlObfuscator.decode(new int[] { 53, 21, 233, 207, 184, 128, 127 }, 81), UrlObfuscator.decode(new int[] { 37, 228, 206, 218, 172, 156, 112 }, 98), NotificationManager.IMPORTANCE_DEFAULT);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == INSTALL_PERMISSION_REQUEST_CODE) {
            ...
            pendingInstallUri = null;
            // The settings screen has no defined UrlObfuscator.decode(new int[] { 1, 247, 194, 165, 131, 122 }, 115) for this action --
            // resultCode isn't reliable here, so just re-check the real
            // permission state directly instead of trusting it.
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O || getPackageManager().canRequestPackageInstalls()) {
                launchInstall(uri);
            } else {
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 205, 205, 177, 149, 97, 115, 82, 125, 12, 254, 200, 180, 145, 100, 69, 60, 27, 253, 146, 166, 145, 124, 64, 106, 24, 171, 205, 187, 137, 105, 82, 32, 0, 163, 143, 236, 192, 144, 110, 88, 50, 91, 238, 209, 189, 215, 112, 92, 56, 22, 178, 215, 162, 128, 99, 13, 53, 4, 255, 219, 232, 163, 105, 82, 42, 15, 237, 192, 164, 172, 222, 123, 83, 55, 30, 252, 202, 247, 130, 122, 20, 58, 28, 226, 196, 174, 130, 97, 12, 38, 11, 231, 221, 166, 138, 105, 93 }, 132), Toast.LENGTH_LONG).show();
            }
            return;
        }
    ...
    // form, come back 10 minutes later, tap UrlObfuscator.decode(new int[] { 217, 219, 180, 210, 88, 94 }, 149), and the session/CSRF
    // token baked into that already-rendered HTML is long dead server-side.
    // (UrlObfuscator.decode(new int[] { 242, 173, 141, 112, 2, 39, 15, 13, 243, 157, 180, 154, 105, 25, 58, 18, 243, 219, 244, 154, 118, 93, 53, 79, 232, 194, 190, 203, 126, 70, 39, 71, 234, 202, 170, 132, 44, 1, 16, 51, 27, 252, 207, 190, 218, 107, 93, 59, 25, 244, 208, 253 }, 166) is the site
    ...
    protected void onResume() {
        ...
        if (backgroundedAtMillis != 0
                ...
                && webView != null) {
            // Same UrlObfuscator.decode(new int[] { 209, 185, 135, 119, 86, 114, 30, 254, 202, 238, 159, 105, 74, 38, 73, 230, 194, 178, 146, 107, 81, 41, 65, 242, 240, 203, 179, 152, 59, 78, 43, 17, 231 }, 183) trick as pull-to-
