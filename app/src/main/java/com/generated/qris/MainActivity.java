...
public class MainActivity extends AppCompatActivity {
    ...
    private static class LoadingSplashView extends FrameLayout implements SplashController {
        ...
        // it actually does.
        static final float SPEED_MULT = 1.6f;
    ...
    private class AndroidBridge {
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? "Qris" : title;
    ...
    // its own "Qris" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "Qris/" + filename);
