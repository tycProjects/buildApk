...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.evaluateJavascript(
                    ...
                    UrlObfuscator.decode(new int[] { 20, 13, 231, 198, 181, 157, 50, 24, 47, 30, 248, 209, 187, 132, 60, 110, 15, 14, 224, 201, 190, 132, 99, 77, 0, 6, 246, 209, 173, 128, 113, 99, 47, 42, 16, 249, 149, 160, 141, 112, 86, 51, 25, 226, 154, 140, 173, 112, 94, 43, 28, 226, 197, 175, 162, 104, 88, 51, 15, 230, 215, 129, 141, 116, 78, 91, 99, 9, 238, 206, 191, 194 }, 96) +
                    UrlObfuscator.decode(new int[] { 21, 255, 204, 187, 128, 105, 69, 62, 71, 233, 195, 162, 160, 114, 70, 44, 21, 204, 246, 205, 169, 153, 117, 95, 43, 80, 176, 213, 185, 157, 112, 89, 118, 92, 233, 219, 163, 143, 127, 67, 38, 6, 175, 195, 236, 159 }, 113) +
                    "var t=e.target;var el=t&&t.closest?t.closest('button,a,[role=\"button\"],input[type=\"button\"],input[type=\"submit\"]'):null;" +
                    UrlObfuscator.decode(new int[] { 235, 199, 232, 186, 146, 59, 26, 44, 19, 247, 220, 184, 129, 59, 117, 61, 22, 227, 223, 166, 138, 79, 94, 34, 14, 238, 205, 225, 192, 68, 74, 39, 16, 238, 201, 219, 156, 143, 117, 95, 61, 28, 182, 193, 191, 151, 102, 82, 38, 20, 185, 212, 143, 131, 104, 89, 37, 0, 236, 229, 180, 140, 96, 68, 39, 79, 246, 246, 220, 175, 157, 111, 95, 113, 81, 172, 203 }, 130) +
                    UrlObfuscator.decode(new int[] { 238, 158, 165, 130, 122, 75, 100, 87, 246, 215, 170, 137, 115, 69, 45, 76, 230, 139, 186, 157 }, 147) +
                    // Polyfills the Web Share API on top of the real Android
                    // share sheet -- most WebView builds don't implement
                    // navigator.share at all, so a page's own UrlObfuscator.decode(new int[] { 247, 171, 131, 115, 69 }, 164) button
                    ...
                    UrlObfuscator.decode(new int[] { 193, 166, 138, 105, 88, 54, 71, 249, 196, 162, 143, 101, 94, 102, 38, 232, 193, 182, 140, 107, 69, 2, 45, 23, 249, 219, 190, 220, 63, 121, 57, 18, 231, 219, 186, 150, 83, 66, 38, 10, 234, 201, 229, 153, 97, 73, 53, 3, 163, 130, 226, 140, 96, 86, 86, 57, 28, 232, 212, 168, 215, 107, 95, 55, 7, 241, 154, 169 }, 181) +
                    UrlObfuscator.decode(new int[] { 168, 132, 114, 74, 37, 0, 244, 240, 204, 243, 143, 115, 91, 43, 29, 170, 208, 160, 154, 112, 70, 56, 31, 225, 134, 169, 141, 127, 75, 96, 19 }, 198) +
                    UrlObfuscator.decode(new int[] { 179, 151, 97, 85, 110, 22, 240, 196, 174, 146, 113, 87, 54, 81 }, 215) +
                    UrlObfuscator.decode(new int[] { 156, 117, 95, 62, 37, 237, 198, 179, 143, 150, 122, 127, 46, 18, 254, 222, 189, 217, 101, 93, 53, 1, 247, 153, 131, 155, 124, 68, 34, 12, 162, 205, 169, 147, 103, 11, 48, 10, 246, 205, 165, 163, 130, 58, 27, 114, 86, 202, 204, 165, 159, 123, 83, 123, 22, 240, 196, 174, 192, 121, 73, 51, 30, 245, 212, 224, 193, 44, 8, 16, 22, 243, 201, 209, 185, 213, 120, 90, 46, 24, 182, 194, 164, 153, 104, 79, 117, 86, 185, 134, 245 }, 232) +
                    UrlObfuscator.decode(new int[] { 139, 125, 67, 35, 7, 250, 147, 130, 131, 127, 66, 39, 30, 233, 133, 184, 140, 123, 72, 42, 19, 225, 139, 235, 218, 125, 124, 95, 41, 31, 243, 146, 188, 209, 108, 68, 48, 0, 230, 192, 191, 208, 95, 92, 34, 1, 226, 217, 172, 198, 117, 67, 47, 1, 224, 214, 233, 133, 214, 37, 64, 33, 64 }, 249) +
                    UrlObfuscator.decode(new int[] { 100, 72, 62, 14, 225, 196, 176, 140, 112, 15, 35, 62, 16, 206, 212, 186, 136, 124, 5, 49, 3, 251, 215, 167, 155, 126, 94, 103, 71, 246, 222, 174, 158, 124, 90, 41, 70, 241, 214, 182, 135, 58, 93, 4 }, 266) +
                    UrlObfuscator.decode(new int[] { 102, 71, 58, 25, 227, 213, 189, 220, 118, 27, 42, 13 }, 283) +
                    ...
                    UrlObfuscator.decode(new int[] { 69, 34, 22, 245, 196, 170, 195, 43, 94, 33, 9, 226, 202, 179, 205, 93, 126, 33, 49, 26, 239, 211, 178, 158, 74, 91, 37, 25, 249, 216, 145, 157, 100, 94, 43, 71, 246, 219, 162, 132, 109, 71, 48, 72, 218, 251, 162, 140, 101, 82, 80, 55, 25, 207, 216, 168, 150, 116, 91, 20, 26, 225, 221, 182, 204, 100, 93, 59, 8, 183 }, 49) +
                    UrlObfuscator.decode(new int[] { 52, 0, 242, 191, 206, 184, 146, 127, 83, 55, 31, 170, 208, 180, 152, 96, 87, 106 }, 66) +
                    UrlObfuscator.decode(new int[] { 36, 27, 255, 212, 160, 153, 35, 77, 47, 14, 204, 222, 162, 136, 113, 104, 42, 17, 245, 197, 209, 187, 143, 52, 28, 41, 26, 234, 216, 186, 153, 51, 31, 52, 4, 254, 204, 186, 132, 99, 69, 98, 12, 161, 220 }, 83) +
                    UrlObfuscator.decode(new int[] { 13, 229, 138, 177, 133, 145, 122, 84, 50, 28, 179, 203, 189, 131, 99, 71, 58, 72, 226, 212, 190, 139, 103, 67, 43, 86, 254, 219, 189, 130, 61 }, 100) +
                    UrlObfuscator.decode(new int[] { 7, 241, 194, 167, 148, 99, 91, 15, 3, 229, 198, 171, 157, 97, 72, 40, 35, 246, 194, 175, 132, 40, 121, 75, 51, 31, 239, 211, 182, 150, 63, 31, 46, 4, 246, 220, 181, 153, 97, 73, 112, 10, 234, 198, 186, 141, 60 }, 117) +
                    UrlObfuscator.decode(new int[] { 240, 196, 182, 195, 103, 77, 125, 119, 27, 179, 200, 186, 136, 126, 93, 35, 80, 179, 209, 253, 134, 112, 66, 40, 11, 249, 130, 165, 133, 109, 77, 19, 31, 245, 193, 254, 223, 60, 17, 22, 97, 24, 178, 207, 187, 139, 127, 82, 34, 79, 240, 220, 177, 132, 125, 74, 32, 25, 162, 216, 169, 155, 103, 75, 42, 12, 234, 196, 135, 141, 101, 114, 91, 51, 8, 160 }, 134) +
                    UrlObfuscator.decode(new int[] { 225, 215, 167, 212, 103, 93, 33, 77, 234, 194, 242, 137, 103, 4, 58, 11, 245, 201, 169, 136, 87, 77, 49, 90, 79, 165 }, 151) +
                    UrlObfuscator.decode(new int[] { 193, 161, 206, 114, 77, 45, 6, 238, 215, 145, 159, 147, 120, 73, 53, 16, 252, 245, 164, 156, 112, 84, 55, 87, 182, 238, 160, 137, 126, 68, 35, 13, 202, 213, 175, 129, 99, 70, 108, 19, 229, 239, 209, 175, 136, 72, 89, 43, 23, 251, 218, 129, 155, 99, 27, 42, 49, 225, 202, 191, 131, 98, 78, 11, 26, 238, 194, 162, 129, 45, 80, 36, 16, 16, 236, 201, 143, 152, 104, 86, 52, 27, 194, 218, 164, 219, 102, 94, 32, 19, 190, 132, 247, 150 }, 168) +
                    UrlObfuscator.decode(new int[] { 196, 241, 204, 107, 25, 32, 1, 231, 212, 249, 212, 115, 80, 47, 10, 254, 202, 160, 207, 99, 12, 63, 30 }, 185) +
                    UrlObfuscator.decode(new int[] { 183, 192, 32, 14, 125 }, 202),
                    null);
            }
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                ...
                if (rel.isEmpty()) rel = UrlObfuscator.decode(new int[] { 178, 148, 125, 93, 47, 88, 253, 192, 190, 158 }, 219);

                byte[] data = EmbeddedAssets.get(rel);
                if (data == null) return super.shouldInterceptRequest(view, request);

                return new WebResourceResponse(guessEmbeddedMime(rel), UrlObfuscator.decode(new int[] { 185, 95, 108, 100, 80 }, 236), new ByteArrayInputStream(data));
            }

            private String guessEmbeddedMime(String rel) {
                String lower = rel.toLowerCase();
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 211, 116, 79, 55, 21 }, 253)) || lower.endsWith(UrlObfuscator.decode(new int[] { 32, 69, 56, 6 }, 270))) return UrlObfuscator.decode(new int[] { 107, 91, 37, 8, 180, 210, 173, 149, 123 }, 287);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 27, 55, 0, 225 }, 53))) return UrlObfuscator.decode(new int[] { 50, 0, 252, 215, 237, 130, 115, 108 }, 70);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 121, 28, 230 }, 87)) || lower.endsWith(UrlObfuscator.decode(new int[] { 70, 234, 204, 182 }, 104))) return UrlObfuscator.decode(new int[] { 24, 232, 199, 186, 156, 119, 82, 38, 24, 255, 193, 225, 135, 109, 93, 43, 26, 235, 213, 175, 149, 112 }, 121);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 164, 195, 187, 136, 104 }, 138))) return UrlObfuscator.decode(new int[] { 250, 202, 169, 148, 126, 85, 52, 0, 250, 221, 191, 223, 101, 93, 34, 2 }, 155);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 130, 184, 156, 110 }, 172))) return UrlObfuscator.decode(new int[] { 212, 177, 154, 125, 92, 119, 4, 224, 210, 255, 139, 127, 93 }, 189);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 224, 157, 98, 76 }, 206))) return UrlObfuscator.decode(new int[] { 182, 147, 124, 91, 62, 85, 233, 214, 176 }, 223);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 222, 101, 94, 42 }, 240)) || lower.endsWith(UrlObfuscator.decode(new int[] { 47, 74, 79, 59, 26 }, 257))) return UrlObfuscator.decode(new int[] { 123, 92, 49, 8, 235, 130, 166, 155, 111, 78 }, 274);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 13, 37, 8, 230 }, 291))) return UrlObfuscator.decode(new int[] { 80, 53, 22, 241, 208, 251, 148, 123, 87 }, 57);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 100, 30, 237, 197, 182 }, 74))) return UrlObfuscator.decode(new int[] { 50, 23, 248, 223, 178, 217, 98, 81, 49, 2 }, 91);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 66, 252, 197, 175, 142, 53 }, 108))) return UrlObfuscator.decode(new int[] { 27, 243, 213, 174, 214, 111, 88, 48, 19, 166 }, 125);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 160, 218, 163, 141, 108 }, 142))) return UrlObfuscator.decode(new int[] { 249, 209, 179, 136, 52, 77, 54, 30, 241 }, 159);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 158, 187, 154, 107 }, 176))) return UrlObfuscator.decode(new int[] { 167, 143, 145, 106, 18, 40, 15, 252 }, 193);
                if (lower.endsWith(UrlObfuscator.decode(new int[] { 252, 152, 115, 64 }, 210))) return UrlObfuscator.decode(new int[] { 138, 111, 64, 39, 58, 81, 229, 145, 178, 153, 118, 86 }, 227);
                return UrlObfuscator.decode(new int[] { 149, 99, 66, 61, 25, 236, 207, 185, 133, 100, 68, 102, 7, 228, 210, 160, 144, 46, 81, 53, 18, 26, 255, 208 }, 244);
            }
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            // UrlObfuscator.decode(new int[] { 86, 71, 34, 12, 161, 241, 237 }, 261) feature or a video-chat widget using getUserMedia().
            // Without this override the WebView auto-denies every such
            // request, which is what was showing as UrlObfuscator.decode(new int[] { 85, 84, 57, 22, 224, 208, 240, 159, 107, 95, 33, 2, 249, 218, 161, 136, 104, 47, 100, 67, 162, 129, 224, 255, 222, 61, 28, 123, 90, 185, 151, 248, 214, 113, 81, 61, 27, 244, 212, 239, 129, 127, 12, 62, 4, 232, 222, 166, 143, 105, 69, 33, 14, 228 }, 278) -- the app never even asked Android for
            ...
            // watchPosition() calls (e.g. a UrlObfuscator.decode(new int[] { 65, 47, 11, 224, 131, 177, 149, 111, 109, 91, 46, 92, 245, 223, 184, 138, 55, 91, 48 }, 295) feature).
            ...
            // UrlObfuscator.decode(new int[] { 78, 53, 28, 244, 153, 177, 153, 54, 66, 61, 7, 250, 145, 160, 128, 126, 88, 60 }, 61) flows work. A bare WebView has nowhere to put
            // that second window, so without this override the popup silently
            // fails (or opens detached from the parent page) and the auth
            // handler comes back with UrlObfuscator.decode(new int[] { 26, 5, 233, 139, 184, 140, 121, 82, 35, 22, 240, 198, 166, 193, 97, 124, 74, 52, 19, 245, 154, 176, 139, 55, 95, 59, 2, 242, 222, 184, 148 }, 78).
            //
            ...
            public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
                ...
                // needs the same UrlObfuscator.decode(new int[] { 100, 94, 234, 202, 242 }, 95)/UrlObfuscator.decode(new int[] { 38, 234, 220, 190, 133, 100, 68, 102, 48, 169, 254, 229 }, 112) stripping or it hits
                // the same silent block.
                String popupDefaultUA = popupSettings.getUserAgentString();
                popupSettings.setUserAgentString(popupDefaultUA.replace(UrlObfuscator.decode(new int[] { 186, 128, 200, 168 }, 129), "").replaceAll("Version/[0-9.]+\s", ""));
                ...
                popupWebView.setWebViewClient(new WebViewClient() {
                    // window.open() targets (like the UrlObfuscator.decode(new int[] { 199, 193, 180, 142, 122, 72, 108, 5, 229, 222 }, 146) link) can land
                    ...
                    // and shows Android's raw UrlObfuscator.decode(new int[] { 244, 167, 131, 112, 126, 89, 56, 92, 245, 213, 173, 216, 118, 64, 52, 29, 255, 211, 179, 156, 106, 14, 98, 102, 171, 138, 233, 200, 39, 6, 101, 68, 163, 130, 225, 192, 223, 62, 29, 124, 91, 186, 153, 248, 216, 57, 21, 17, 33, 192, 238, 133, 161, 69, 99, 3, 60, 196, 246, 157, 181, 74, 122, 23, 32, 202, 228, 141, 154 }, 163) error. Intercept here and hand the URL
                    ...
                    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                        ...
                        if (scheme != null && !scheme.equals(UrlObfuscator.decode(new int[] { 220, 167, 134, 97 }, 180)) && !scheme.equals(UrlObfuscator.decode(new int[] { 173, 144, 119, 82, 50 }, 197))) {
                            try {
    ...
    private String baseUrl() {
        return EMBED_HOST + UrlObfuscator.decode(new int[] { 191, 155, 112, 86, 42, 95, 248, 219, 163, 129 }, 214);
    }
    ...
    private String resolveStartUrl(Intent intent) {
        ...
        if (Intent.ACTION_SEND.equals(action) && UrlObfuscator.decode(new int[] { 147, 99, 93, 48, 76, 242, 205, 161, 182, 144 }, 231).equals(intent.getType())) {
            String shared = intent.getStringExtra(Intent.EXTRA_TEXT);
            if (shared != null && !shared.isEmpty()) {
                try {
                    return baseUrl() + UrlObfuscator.decode(new int[] { 199, 100, 94, 52, 6, 246, 214, 142, 132, 106, 86, 57, 81 }, 248) + java.net.URLEncoder.encode(shared, UrlObfuscator.decode(new int[] { 92, 124, 1, 75, 189 }, 265));
    ...
    protected void onNewIntent(Intent intent) {
        ...
        String shortcutAction = intent.getStringExtra(UrlObfuscator.decode(new int[] { 105, 81, 55, 5, 226, 214, 161, 135, 77, 80, 51, 27, 231, 194, 162 }, 282));
        if (UrlObfuscator.decode(new int[] { 66, 42, 2, 226, 205, 175 }, 48).equals(shortcutAction)) {
            webView.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);
            webView.reload();
            webView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            return;
        }
        if (UrlObfuscator.decode(new int[] { 41, 15, 18, 251 }, 65).equals(shortcutAction)) {
    ...
    // system bars to match the page's own <meta name=UrlObfuscator.decode(new int[] { 38, 25, 245, 194, 171, 192, 111, 68, 38, 6, 250 }, 82)>
    ...
    private class AndroidBridge {
        ...
        public void share(String title, String text, String url) {
            runOnUiThread(() -> {
                try {
                    ...
                    sendIntent.setType(UrlObfuscator.decode(new int[] { 23, 231, 217, 180, 240, 142, 113, 93, 50, 20 }, 99));
        ...
        // the app is open or backgrounded (e.g. on a socket.io UrlObfuscator.decode(new int[] { 26, 246, 197, 241, 157, 106, 93, 62, 13, 236, 207 }, 116)
        ...
        public void showNotification(String title, String body) {
            runOnUiThread(() -> {
                ...
                String safeTitle = (title == null || title.trim().isEmpty()) ? UrlObfuscator.decode(new int[] { 228, 205, 174, 194, 109, 79, 92, 53 }, 133) : title;
                String safeBody = body == null ? "" : body;
                NotificationCompat.Builder notification = new NotificationCompat.Builder(MainActivity.this, UrlObfuscator.decode(new int[] { 242, 208, 178, 146, 103, 93, 36 }, 150))
        ...
        // which surfaces as a raw UrlObfuscator.decode(new int[] { 240, 163, 135, 116, 66, 37, 4, 160, 241, 209, 169, 220, 122, 76, 56, 17, 251, 215, 183, 152, 118, 18, 126, 80, 202, 252, 159, 179, 72, 101, 7, 38, 194, 229, 145, 173, 76, 108, 30, 50, 58, 205, 248, 136 }, 167)
        ...
        public void applyThemeColor(String hex) {
            if (hex == null || !hex.matches(UrlObfuscator.decode(new int[] { 230, 244, 222, 78, 117, 126, 52, 240, 157, 169, 222, 32, 21, 22, 17, 191, 213, 187, 189, 68, 9, 5, 3, 172, 198, 143, 243, 196, 65, 64, 105, 4, 177, 147 }, 184))) return;
            runOnUiThread(() -> {
                try {
    ...
    //    UrlObfuscator.decode(new int[] { 141, 135, 112, 72, 41, 11, 226, 198, 225, 131, 144, 115, 77, 48, 30, 238, 220 }, 201)) instead of the app being the only place any
    //    progress is visible;
    ...
    // its own UrlObfuscator.decode(new int[] { 187, 144, 117, 23, 58, 26, 247, 216 }, 218) subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.addRequestHeader(UrlObfuscator.decode(new int[] { 190, 121, 76, 58, 74, 199, 194, 161, 141, 118 }, 235), userAgent);
            if (cookie != null) request.addRequestHeader(UrlObfuscator.decode(new int[] { 191, 116, 85, 50, 17, 242 }, 252), cookie);
            request.setTitle(filename);
            request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, UrlObfuscator.decode(new int[] { 108, 69, 38, 74, 229, 199, 164, 141, 42 }, 269) + filename);
            ...
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 90, 82, 43, 21, 246, 214, 185, 147, 127, 91, 51, 83 }, 286) + filename + "…", Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 112, 60, 5, 255, 220, 160, 143, 105, 12, 45, 11, 224, 196, 162, 130, 37, 9, 110, 66, 226, 200, 218, 189, 150, 60, 66, 53, 12, 234, 151, 181, 154, 122, 93, 55, 18, 228, 198, 161, 131, 44, 74, 36, 13, 168, 211, 180, 156, 36, 66, 37, 0, 233, 241 }, 52), Toast.LENGTH_LONG).show();
        }
    }

    // Confirms the download actually finished (or explains why it didn't)
    // instead of leaving the UrlObfuscator.decode(new int[] { 1, 11, 244, 204, 173, 143, 158, 122, 84, 50, 28, 180, 151, 246 }, 69) toast above as the last word
    ...
    private void handleDownloadComplete(long id) {
        ...
        try {
            ...
            String title = (titleIdx >= 0 && cursor.getString(titleIdx) != null) ? cursor.getString(titleIdx) : UrlObfuscator.decode(new int[] { 16, 28, 248, 214 }, 86);

            if (status == DownloadManager.STATUS_SUCCESSFUL) {
                String localUriStr = uriIdx >= 0 ? cursor.getString(uriIdx) : null;
                String folderName = UrlObfuscator.decode(new int[] { 35, 233, 210, 170, 143, 109, 64, 36, 44 }, 103);
                ...
                if (localUriStr != null) {
                    ...
                    if (path != null) {
                        ...
                        // the saved path (rather than hardcoding UrlObfuscator.decode(new int[] { 60, 248, 193, 187, 152, 124, 83, 53, 3 }, 120))
                ...
                Toast.makeText(this, title + UrlObfuscator.decode(new int[] { 169, 204, 168, 145, 107, 72, 44, 3, 229, 197, 219, 254, 8425, 60, 93, 51, 23, 252, 151, 191, 129, 52, 90, 60, 81, 233, 192, 187, 159, 44 }, 137) + folderName + UrlObfuscator.decode(new int[] { 186, 223, 183, 155, 114, 80, 38 }, 154), Toast.LENGTH_LONG).show();
                ...
                // links to) still behaves exactly as before, since UrlObfuscator.decode(new int[] { 194, 164, 154, 124, 70, 42, 9 }, 171)
    ...
    // in the wrapped page's script. Without this, the button's UrlObfuscator.decode(new int[] { 100, 112, 80, 56 }, 256) state
    // was just a fixed timer guessing how long a download UrlObfuscator.decode(new int[] { 97, 66, 32, 12, 236, 206, 167, 147 }, 273) takes,
    // with no way to know the real file size or connection speed -- so a
    // large APK on a slow connection could show UrlObfuscator.decode(new int[] { 81, 41, 15, 10, 242, 217, 252, 153, 127, 25, 49, 25, 182, 204, 187, 134, 96, 59, 112, 79, 174, 141, 227, 196, 42, 77, 39, 16, 232, 201, 171, 130, 102, 82 }, 290) while DownloadManager was still genuinely working. Fire-
        ...
        runOnUiThread(() -> {
            try {
                webView.evaluateJavascript(
                    UrlObfuscator.decode(new int[] { 76, 37, 15, 238, 221, 181, 218, 102, 89, 33, 10, 226, 219, 229, 181, 86, 71, 41, 40, 228, 208, 170, 148, 100, 100, 80, 41, 19, 240, 212, 187, 157, 91, 88, 59, 5, 248, 214, 166, 148, 57, 84, 57, 4, 226, 207, 165, 158, 38, 120, 25, 10, 234, 237, 163, 149, 105, 105, 91, 25, 19, 236, 212, 181, 151, 118, 82, 22, 27, 254, 194, 189, 149, 123, 75, 101 }, 56) + success + UrlObfuscator.decode(new int[] { 96, 83, 250, 219, 166, 133, 119, 65, 41, 72, 26, 183, 198, 161 }, 73),
                    null);
            } catch (Exception ignored) {
    ...
    // it (rather than a generic UrlObfuscator.decode(new int[] { 61, 22, 184, 195, 185, 213, 71, 86, 38, 5, 249, 193, 169, 158 }, 90) toast) and parks the
    ...
    private void requestInstall(Uri contentUri) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && !getPackageManager().canRequestPackageInstalls()) {
            ...
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 42, 230, 197, 167, 144, 38, 76, 42, 16, 246, 192, 172, 179, 141, 61, 90, 41, 21, 244, 152, 163, 158, 124, 71, 115, 19, 225, 192, 227, 206, 121, 68, 46, 4, 169, 193, 179, 193, 105, 72, 99, 1, 238, 206, 203, 183, 147, 105, 94, 122, 24, 237, 195, 185, 152, 117, 71, 59, 18, 241, 195, 162, 148 }, 107), Toast.LENGTH_LONG).show();
            try {
                Intent settingsIntent = new Intent(Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES,
                    Uri.parse(UrlObfuscator.decode(new int[] { 12, 250, 217, 178, 153, 112, 83, 111 }, 124) + getPackageName()));
    ...
    private void launchInstall(Uri contentUri) {
        ...
        installIntent.setDataAndType(contentUri, UrlObfuscator.decode(new int[] { 236, 220, 187, 134, 96, 75, 38, 18, 236, 203, 173, 205, 119, 78, 91, 112, 28, 242, 223, 168, 150, 113, 83, 120, 5, 245, 208, 185, 144, 119, 74, 99, 12, 254, 200, 162, 128, 126, 66 }, 141));
        installIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_GRANT_READ_URI_PERMISSION);
        try {
            startActivity(installIntent);
        } catch (ActivityNotFoundException e) {
            Toast.makeText(this, UrlObfuscator.decode(new int[] { 208, 210, 252, 146, 116, 74, 44, 22, 250, 217, 177, 129, 50, 87, 63, 26, 224, 201, 236, 198, 39, 9, 39, 23, 227, 203, 228, 151, 106, 68, 96, 57, 23, 241, 217, 251, 156, 107, 87, 58, 86, 236, 219, 166, 128, 49, 116, 32, 25, 227, 192, 164, 139, 109, 91, 103, 0, 234, 200, 167, 135, 115, 0, 86, 48, 14, 232, 222, 187, 157 }, 158), Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == STORAGE_PERMISSION_REQUEST_CODE && pendingDownload != null) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 252, 186, 130, 126, 74, 45, 12, 168, 215, 163, 151, 105, 74, 49, 18, 233, 240, 208, 253, 149, 104, 26, 55, 29, 242, 210, 176, 144, 51, 70, 62, 80, 252, 207, 187, 137, 43, 94, 33, 13, 167, 194, 170, 147, 109, 78, 46, 1, 27 }, 175), Toast.LENGTH_LONG).show();
            }
            ...
            if (grantedResources.isEmpty()) {
                request.deny();
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 131, 190, 147, 120, 78, 58, 85, 244, 209, 180, 132, 122, 68, 59, 29, 255, 213, 239, 158, 104, 94, 38, 3, 250, 219, 174, 137, 107, 4, 42, 17, 161, 206, 218, 187, 153, 121, 95, 122, 31, 247, 197, 246, 129, 124, 90, 33 }, 192), Toast.LENGTH_LONG).show();
            } else {
            ...
            if (!granted) {
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 157, 159, 108, 79, 57, 5, 228, 196, 233, 152, 98, 84, 40, 13, 240, 209, 168, 143, 145, 62, 84, 47, 91, 244, 220, 189, 147, 115, 81, 116, 21, 253, 195, 240, 155, 102, 68, 63 }, 209), Toast.LENGTH_LONG).show();
            }
        } else if (requestCode == NOTIFICATION_PERMISSION_REQUEST_CODE) {
            if (!(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)) {
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 172, 110, 84, 86, 56, 20, 255, 218, 174, 144, 119, 89, 37, 85, 245, 193, 183, 209, 127, 73, 40, 77, 234, 196, 184, 201, 124, 79, 47, 22, 164, 194, 178, 145, 32, 50, 19, 125, 8, 238, 200, 183, 216, 99, 94, 48, 25, 179, 221, 191, 208, 102, 64, 109, 63, 238, 222, 189, 129, 105, 65, 54, 68, 226, 204, 184, 192, 139, 119, 80, 57 }, 226), Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void createNotificationChannel() {
        ...
        NotificationChannel channel = new NotificationChannel(
            UrlObfuscator.decode(new int[] { 151, 119, 87, 49, 26, 226, 217 }, 243), UrlObfuscator.decode(new int[] { 67, 70, 44, 4, 242, 254, 210 }, 260), NotificationManager.IMPORTANCE_DEFAULT);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == INSTALL_PERMISSION_REQUEST_CODE) {
            ...
            pendingInstallUri = null;
            // The settings screen has no defined UrlObfuscator.decode(new int[] { 103, 81, 32, 7, 253, 196 }, 277) for this action --
            // resultCode isn't reliable here, so just re-check the real
            // permission state directly instead of trusting it.
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O || getPackageManager().canRequestPackageInstalls()) {
                launchInstall(uri);
            } else {
                Toast.makeText(this, UrlObfuscator.decode(new int[] { 111, 43, 23, 247, 195, 173, 140, 223, 110, 88, 46, 22, 243, 202, 171, 158, 121, 91, 116, 4, 243, 194, 190, 200, 122, 13, 43, 25, 235, 199, 188, 130, 98, 5, 105, 78, 162, 206, 176, 186, 144, 61, 72, 51, 31, 185, 222, 190, 154, 112, 20, 53, 0, 254, 221, 239, 151, 98, 89, 57, 74, 205, 199, 176, 136, 105, 75, 34, 6, 242, 128, 217, 177, 145, 120, 94, 40, 89, 236, 216, 246, 156, 122, 64, 38, 16, 252, 195, 238, 128, 109, 69, 63, 8, 228, 203, 191 }, 294), Toast.LENGTH_LONG).show();
            }
            return;
        }
    ...
    // form, come back 10 minutes later, tap UrlObfuscator.decode(new int[] { 112, 52, 29, 185, 241, 185 }, 60), and the session/CSRF
    // token baked into that already-rendered HTML is long dead server-side.
    // (UrlObfuscator.decode(new int[] { 25, 4, 226, 217, 233, 142, 104, 84, 40, 68, 235, 195, 178, 192, 157, 123, 88, 50, 91, 243, 221, 180, 146, 54, 83, 59, 1, 178, 197, 191, 128, 46, 65, 35, 5, 237, 135, 232, 183, 106, 64, 37, 16, 231, 129, 178, 186, 146, 114, 93, 63, 84 }, 77) is the site
    ...
    protected void onResume() {
        ...
        if (backgroundedAtMillis != 0
                ...
                && webView != null) {
            // Same UrlObfuscator.decode(new int[] { 56, 18, 238, 216, 191, 217, 119, 89, 51, 85, 230, 214, 179, 157, 48, 65, 43, 25, 251, 196, 184, 130, 40, 85, 41, 16, 234, 199, 226, 149, 114, 118, 78 }, 94) trick as pull-to-
