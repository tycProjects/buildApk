...
public final class ServerConfig {
    ...
    public static String getBaseUrl() {
        return decode(new int[] { 197, 184, 159, 122, 90, 114, 72, 169, 214, 161, 151, 118, 72, 46, 56, 13, 179, 219, 169, 155, 125, 84, 50, 89, 230, 209, 167, 134, 120, 94, 40, 29, 163, 203, 185, 139, 109, 68, 34, 72, 238, 208, 176 }, 173);
    }
