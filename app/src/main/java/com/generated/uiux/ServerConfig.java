...
public final class ServerConfig {
    ...
    public static String getBaseUrl() {
        return decode(new int[] { 197, 184, 159, 122, 90, 114, 72, 169, 194, 173, 151, 106, 84, 34, 113, 29, 242, 209, 244, 142, 96, 91, 7, 4, 250, 222, 182, 145, 101, 67, 96, 20, 228, 220, 230, 158, 102, 5, 38, 22, 238 }, 173);
    }
