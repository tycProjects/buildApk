package com.generated.tiktokcopy;
...
public class MainActivity extends AppCompatActivity {
    ...
    // built-in text animations: either a short looping video (custom_splash
    // in res/raw) or a single still image (custom_splash in res/drawable).
    ...
    private static class CustomSplashView extends FrameLayout implements SplashController {
        ...
        public void show() {
            ...
            if (isVideo && videoView != null) videoView.start();
        }
    ...
    // its own "tiktok copy" subfolder in there (DownloadManager
    ...
    private void startDownload(String url, String userAgent, String contentDisposition, String mimeType) {
        ...
        try {
            ...
            request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "tiktok copy/" + filename);
