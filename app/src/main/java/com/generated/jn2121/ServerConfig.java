...
public final class ServerConfig {
    ...
    public static String getBaseUrl() {
        return decode(new int[] { 197, 184, 159, 122, 90, 114, 72, 169, 198, 182, 134, 99, 85, 41, 41, 27, 176, 209, 190, 158, 118, 78, 62, 29, 184, 209, 230, 198, 114, 85, 43, 64, 227, 201, 191, 134, 96, 78, 62, 72, 228, 212, 179, 205 }, 173);
    }
