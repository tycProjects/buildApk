...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // swipe-down-to-reload gesture almost for free -- it only actually
        // triggers when the WebView itself is scrolled all the way to the
        // top, so it doesn't fight with the page's own scrolling.
