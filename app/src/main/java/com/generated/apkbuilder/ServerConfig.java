...
public final class ServerConfig {
    ...
    public static String getBaseUrl() {
        return decode(new int[] { 197, 184, 159, 122, 90, 114, 72, 169, 223, 173, 147, 47, 85, 47, 114, 31, 237, 215, 246, 153, 124, 13, 100, 88, 250, 218, 161, 151, 127, 84, 42, 28, 163, 207, 164, 135, 38 }, 173);
    }
